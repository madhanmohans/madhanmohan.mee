...
1. Leverage [[hardware-accelerator]]
2. Use mobile-optimized architecture
3. Apply [[quantization]]
4. Apply [[pruning]]

Formats: [[tensorflow-lite]], [[json-format]] + bin

Platforms: Android, Raspberry Pi, [[google-coral]]

High-level APIs: [[ml-kit]]
