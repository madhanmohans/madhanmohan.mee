...
- _Build.gradle_ file includes all the dependencies, version names, minimum and stable sdk versions in one file and it can updated to be reflected on each build.
