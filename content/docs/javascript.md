...
`Array.prototype.splice()`: Changes the contents of an array by removing or replacing existing elements.
...
`String.prototype.indexOf()`: Returns the index within the calling String object of the first occurrence of the specified value.
`String.prototype.lastIndexOf()`: Returns the index within the calling String object of the last occurrence of the specified value.
