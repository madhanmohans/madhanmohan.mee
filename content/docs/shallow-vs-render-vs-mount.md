...
- mount(<Component/>) - Mounting is the phase in which our React component mounts on the Full DOM (i.e., is created and inserted into the DOM). - Used for testing User flows and lifecycles. - When interacting with other DOM APIs, we need to make sure that the DOM is mounted.
