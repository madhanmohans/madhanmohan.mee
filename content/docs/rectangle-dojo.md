...
- No duplication
- Fewest elements
  Not every usage of a number is a magic number . In this context try asking a question to yourself “what is the formula to compute perimeter of a square” - your answer would be 4 _ side . You would never say “number of sides _ side” . So just represent this.
