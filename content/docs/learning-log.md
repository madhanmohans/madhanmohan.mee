...
- Built a Scratch application - _Shootout_.
...
- Implemeted Array data structure
  ...
  - Member Initializer list
    ...
    > When you **_initialize_** fields via Member initializer list the constructors will be called once and the object will be constructed and initialized in one operation.
    >
    > If you use **_assignment_** then the fields will be first initialized with default constructors and then reassigned (via assignment operator) with actual values.
...
- Solved Climbing Stairs leetcode problem
- Almost finished Scratch Project 'Shootout!'
- Setup Habitica + Anki + Obsidian workflow
- [[My Simple Workflow while learning something new]]
...
- [x] Work on a [[Leetcode Patterns]] Problem
- [x] Implement Array
- [x] Complete current Work chores
...
1. [[consciousness-universe-questions|Consciousness]]
2. [[maximum-subarray]]
3.
...
- [x] Update [[Linkedin about]]
- [x] Complete [[Scratch Project]]
- [x] Write Chess workflow [[Chess Readme]]
- [x] Implement Array
...
- [ ] Build a blog site
- [x] Learn about aand use .gitignore
- [ ] Update Leetcode database
- [x] Finish Teams Chores
