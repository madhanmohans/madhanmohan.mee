...
1. GitHub repo with clean commits for working service with REST API and WebSocket server

2. Basic documentation explaining design decisions

3. 1-2 min public youtube video link that shows functionality
